...
// import { Back } from '../shared/social-icons';
...
//                     components={{
//                       View: ({ data }) => {
//                         console.log('Inside components data', data.fluid, getImage(data.fluid));
//                         // Or render your own image.
//                           <GatsbyImage image={getImage(data.fluid)} caption={data.data} />;
//                       },
//                     }}
//                   />
//                 </Modal>

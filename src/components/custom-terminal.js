    ...
    return (
        <span style={{ fontFamily: 'Fira Code' }}>
            <p style={{ color: '#268bd2', fontWeight: 'bold' }}>
                To use this terminal, simply type any of the commands listed
                below.
            </p>
            <p>
                <b style={{ color: '#b58900' }}>whoami</b> - get to know me +
                how to contact me
            </p>
            <p>
            ...
            <p>
                <b style={{ color: '#b58900' }}>photos</b> - checkout my
    ...
    return (
        ...
        >
            <p style={{ color: '#cb4b16', fontWeight: '500' }}>
                Hey there! Welcome to my website, thanks for taking the time to
                get to know me.
            </p>
            <p>
